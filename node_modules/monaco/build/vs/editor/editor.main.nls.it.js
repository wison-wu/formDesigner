...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/editor/contrib/format/browser/formatActions": [
		"È stata effettuata una modifica di formattazione a riga {0}",
		"Sono state effettuate {0} modifiche di formattazione a riga {1}",
		"È stata effettuata una modifica di formattazione tra le righe {0} e {1}",
		"Sono state effettuate {0} modifiche di formattazione tra le righe {1} e {2}",
		"Formatta documento",
		"Selezione formato",
	],
	...
	"vs/editor/contrib/referenceSearch/browser/referencesWidget": [
		...
		"Primo piano per l\'immissione di corrispondenze nell\'elenco risultati della visualizzazione rapida.",
		"Primo piano per l\'immissione di file nell\'elenco risultati della visualizzazione rapida.",
	...
	"vs/platform/theme/common/colorRegistry": [
		"Formato colore non valido. Usare #RRGGBB o #RRGGBBAA",
		...
		"Colore generale del bordo/contorno per elementi con lo stato attivo. Questo colore viene usato solo se non è sostituito da quello di un componente.",
		"Colore del bordo per separare i componenti quando è abilitato il tema a contrasto elevato.",
		"Colore del contorno per i componenti attivi quando è abilitato il tema a contrasto elevato.",
