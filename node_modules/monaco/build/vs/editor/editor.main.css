...
.monaco-editor .delete-sign { background-image: url("data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHRpdGxlPkxheWVyIDE8L3RpdGxlPjxyZWN0IGhlaWdodD0iMyIgd2lkdGg9IjExIiB5PSI3IiB4PSIzIiBmaWxsPSIjNDI0MjQyIi8+PC9zdmc+"); }

.monaco-editor.vs-dark .insert-sign, .monaco-editor.hc-black .insert-sign { background-image: url("data:image/svg+xml;base64,"); }
.monaco-editor.vs-dark .delete-sign, .monaco-editor.hc-black .delete-sign { background-image: url("data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHRpdGxlPkxheWVyIDE8L3RpdGxlPjxyZWN0IGhlaWdodD0iMyIgd2lkdGg9IjExIiB5PSI3IiB4PSIzIiBmaWxsPSIjQzVDNUM1Ii8+PC9zdmc+"); }
...
.monaco-editor.vs-dark	.redsquiggly { background: url("data:image/svg+xml;base64,") repeat-x bottom left; }
.monaco-editor.hc-black .redsquiggly { border-bottom: 4px double #E47777; opacity: 0.8; }

.monaco-editor.vs		.greensquiggly,
.monaco-editor.vs-dark	.greensquiggly { background: url("data:image/svg+xml;base64,") repeat-x bottom left; }
...
.monaco-editor .suggest-widget .monaco-list .monaco-list-row .icon.text { background-image: url(contrib/suggest/browser/media/String_16x.svg); }
...
.monaco-editor.hc-black .suggest-widget .monaco-list .monaco-list-row .icon.text { background-image: url(contrib/suggest/browser/media/String_inverse_16x.svg); }
