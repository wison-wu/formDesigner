...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/contrib/referenceSearch/browser/referencesWidget": [
		...
		"Передний план совпадений в списке результатов быстрого редактора.",
		"Передний план записи файла в списке результатов быстрого редактора.",
	...
	"vs/platform/theme/common/colorRegistry": [
		"Недопустимый формат цвета. Используйте #RRGGBB или #RRGGBBAA",
		...
		"Общий цвет структуры и границ для элементов с фокусом. Этот цвет используется, только если его не переопределит компонент.",
		"Цвет границ для разделения компонентов при включенной теме с высокой контрастностью.",
		"Цвет контура для активных компонентов в теме с высокой контрастностью.",
		"Фон поля ввода.",
